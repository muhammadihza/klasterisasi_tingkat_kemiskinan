...
def main_page():
    ...
    kapitalisasi_nama = nama.capitalize()

    with st.sidebar:
        st.write("Selamat datang, ", kapitalisasi_nama)
    ...
    if selected == "Dashboard":
        ...
        if st.session_state.hal_page3 != 1:
            st.info('Silahkan tentukan nilai k sebagai nilai n klaster pada halaman K-Means')
